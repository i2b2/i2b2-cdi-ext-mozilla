...
from i2b2_cdi.fact.fact_validation_helper import initialize_defaults,validate_fact_row
from i2b2_cdi.database import getPdf
import codecs
from i2b2_cdi.database.cdi_database_connections import I2b2crcDataSource

class MozillaDeidFact:
...
def do_deidentify(obs_file_path, concept_map,config):
    ...
    if os.path.exists(obs_file_path):
        D = MozillaDeidFact(config.max_validation_error_count)
